    ...
    public partial class DevelopersForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand sqlcmd = new SqlCommand("AddEditDeleteDev", con);
                ...
                sqlcmd.Parameters.AddWithValue("@date_f", textBox3.Text.Trim());
                sqlcmd.Parameters.AddWithValue("@country", textBox5.Text.Trim());
                sqlcmd.Parameters.AddWithValue("@leader", textBox6.Text.Trim());
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                da.SelectCommand.Parameters.AddWithValue("@company", textBox4.Text.Trim());
