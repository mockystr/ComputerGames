    ...
    public partial class StoresForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand sqlcmd = new SqlCommand("AddEditDeleteStores", con);
                ...
                sqlcmd.Parameters.AddWithValue("@e_a", textBox3.Text.Trim());
                sqlcmd.Parameters.AddWithValue("@des", textBox4.Text.Trim());
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlDataAdapter da = new SqlDataAdapter("SearchByStoreName", con);
        ...
        private void dataGridView1_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                if (dataGridView1.CurrentRow.Index != -1)
                {
                    ...
                    SqlDataAdapter sda = new SqlDataAdapter("SELECT * FROM StoresV WHERE ID='" + id + "'", con);
