...
{
    public partial class AgeLimitForm : Form
    {
        public AgeLimitForm()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {              
                if (con.State == ConnectionState.Closed)
                    ...
                    SqlCommand sqlcmd = new SqlCommand("AddEditDeleteAgeLimit", con);
                    sqlcmd.CommandType = CommandType.StoredProcedure;
                    sqlcmd.Parameters.AddWithValue("@mode", "Add");
                    sqlcmd.Parameters.AddWithValue("@id", textBox1.Text.Trim());
                    sqlcmd.Parameters.AddWithValue("@type", textBox2.Text.Trim());
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlDataAdapter da = new SqlDataAdapter("SearchByTypeAgeLimit", con);
                da.SelectCommand.CommandType = CommandType.StoredProcedure;
                da.SelectCommand.Parameters.AddWithValue("@type", textBox4.Text.Trim());
