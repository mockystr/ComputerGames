...
{
    public partial class GamesRatingReport : Form
    {
        public GamesRatingReport()
        {
            InitializeComponent();
            Search();
        }
        ...
        private void Search()
        {
            try
            {
                ...
                SqlDataAdapter da = new SqlDataAdapter("SearchRatingsGame", con);
                da.SelectCommand.CommandType = CommandType.StoredProcedure;
                da.SelectCommand.Parameters.AddWithValue("@game", textBox1.Text.Trim());
